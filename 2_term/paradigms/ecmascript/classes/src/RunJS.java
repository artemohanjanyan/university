...
public class RunJS {
    ...
    public static void main(final String[] args) throws ScriptException, IOException {
        ...
        engine.eval(new InputStreamReader(new FileInputStream("/home/artem/workspace/study/university/2_sem/paradigms/ecmascript/classes/src/objectExpression.js"), "UTF-8"));
    }
}
